...
Write-Host "Running CLI demo execution: sip-001..." -ForegroundColor Cyan
Write-Host ""
...
# Run the CLI application with demo (headless mode to prevent GUI initialization)
