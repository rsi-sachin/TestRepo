...
Last updated: 2026-07-02 (ORAN-FTM-002/003/004: TS 103 987 Section 6 API definition alignment and regression verification)
...
| ORAN-FTM-002 | Module | A1 Policy Service | Traceability and Quality Follow-up | document-cross-reference-analysis, document-analysis-a1tp, document-analysis-a1td | TS 103 987 Sections 5.2.1, 5.2.2.1-5.2.2.4, 5.2.3, 5.2.4, 6.2 | demo-web/backend/app/services/a1_policy_service.py | ORAN backend | In Progress | Unit tests for policy operations and constraints; interface API regression for policy endpoints | Section 6 alignment completed for policy error contract exposure and method constraint validation; preserve 200 update semantics for conformance |
| ORAN-FTM-003 | Module | A1 Enrichment Service | Traceability and Quality Follow-up; Phase 2 | document-cross-reference-analysis, document-analysis-a1tp | TS 103 987 A1-EI service scope (Section 5.1), Section 6.3; TS 103 989 Section 5.3 | demo-web/backend/app/services/a1_enrichment_service.py; demo-web/backend/app/modules/conformance_harness/service.py; demo-web/backend/app/api/oran.py | ORAN backend | In Progress | Service unit tests, EI conformance tests, interface API regression, and combined conformance run | Section 6 alignment completed for EI endpoint error contract and 405 method-constraint runtime checks |
| ORAN-FTM-004 | Component | ORAN API Router and Service-Aware Endpoints | Traceability and Quality Follow-up | document-cross-reference-analysis, document-analysis-a1tp | TS 103 987 resource model and HTTP operations (Sections 5 and 6) | demo-web/backend/app/api/oran.py; demo-web/backend/app/services/a1_errors.py | ORAN backend | In Progress | API tests for `/api/oran/services`, generation, upload, selection flows; EI conformance category routing tests; Section 6 regression: interface (20 passed) and combined interface+conformance (107 passed) | ProblemDetails-style error handling implemented with `application/problem+json`; explicit 405/409 response modeling verified in OpenAPI and runtime tests |
